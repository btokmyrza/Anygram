...
import kz.btokmyrza.anygram.feature.phone.number.presentation.PhoneNumberUiError

fun mapTdErrorToUiError(context: Context, errorMessage: String): PhoneNumberUiError =
    when (errorMessage) {
