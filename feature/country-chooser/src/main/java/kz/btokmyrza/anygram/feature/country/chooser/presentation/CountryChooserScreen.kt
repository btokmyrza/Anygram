...
private fun CountryChooserContent(
    searchQuery: String,
    isSearching: Boolean,
    displayedCountries: List<CountryChooserUiModel>,
        ...
        topBar = {
            CountryChooserTopBar(
                ...
                onSearchQueryChanged = {
                    onIntent(CountryChooserIntent.OnSearchQueryChanged(searchQuery))
                },
            )
        },
    ) { paddingValues ->
            ...
            key = { countryChooserUiModel ->
                when (countryChooserUiModel) {
                    is CountryChooserUiModel.Country -> {
                        countryChooserUiModel.countryCode
                    }
